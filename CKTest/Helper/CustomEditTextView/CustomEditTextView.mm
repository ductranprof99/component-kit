                       ...
                       onEndEditing:(const CKTypedComponentAction<NSString *> &)onEndEditing
{
    ...
    CustomEditTextView *c = (CustomEditTextView *)[super newWithSize:size accessibility:{}];
    if (c) {
...
@implementation CustomEditTextViewController
...
+ (void)configureStatefulView:(UIView *)statefulView forComponent:(CKComponent *)component
{
    ...
    CustomEditTextView *ctv = (CustomEditTextView *)component;
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
    if ([text isEqualToString:@"\n"]) {
        CustomEditTextView *ctv = (CustomEditTextView *)self.component;
        if (ctv) {
