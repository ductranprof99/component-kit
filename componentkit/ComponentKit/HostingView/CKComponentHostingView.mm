...
- (id<NSObject>)model {
    return _pendingInputs.model;
}

- (void)setModel:(id<NSObject>)model {
    [self updateModel:model mode:CKUpdateModeAsynchronous];
}
...
- (BOOL)isScopeRootReady {
    return _pendingInputs.scopeRoot != nil;
}
