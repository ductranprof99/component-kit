...
typedef struct _CKStateScopeKey {
  ...
  bool operator==(const _CKStateScopeKey &v) const {
    return (CKObjectIsEqual(id<NSObject>(this->componentClass), id<NSObject>(v.componentClass))
            && CKObjectIsEqual(id<NSObject>(this->identifier), id<NSObject>(v.identifier)));
  }
} _CKStateScopeKey;
